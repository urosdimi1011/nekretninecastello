                    ...
                    <div class="navbar d-flex align-items-center p-0">
                        ...
                        <nav class="main-nav on-hover-menu navbar-expand-lg flex-grow-1">
                            ...
                            <ul id="main-nav" class="navbar-nav">
                                ...
                                <li class="nav-item dropdown menu-item-has-children">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @php
                                            ...
                                            if ($slug == 'kuce') $slug = 'kuće';
                                            elseif (str_contains($slug, 'poslovni')) $slug = 'poslovni_prostor';
                                ...
                                <li class="nav-item {{ request()->routeIs('nekretnineSve') ? 'current-menu-item page_item page-item-10 current_page_item' : '' }}">
                                    <a class="nav-link" href="{{ route('nekretnineSve') }}">{{ __('ui.nekretnine') }}</a>
                                </li>
                ...
                <div class="row pt-5 moj-flex">
                    ...
                    <div class="col-5 col-md-5 col-lg-3">
                        ...
                        <ul class="footer_details p-0">
                            ...
                            <li><i class="fa-solid fa-pencil"></i> <span><a href="#"> {{ __('ui.reg_posr') }} <strong>1228</strong></a></span></li>
                            <li><i class="fa-solid fa-pencil"></i> <span><a href="#"> {{ __('ui.licenca') }} <strong>3499</strong></a></span></li>
                        </ul>
                    </div>
                        ...
                        <div class="header-block-content">
                            ...
                            <ul class="footer_details">
                                ...
                                <li class="link nav-item menu-item menu-item-type-post_type menu-item-object-page">
                                    <a class="dropdown-item" href="{{ route('nekretnineSvePoTipu', ['tip' => str_replace("ć","c",strtolower($a->tip))]) }}">{{$a->tip}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="row bt-color pt-2 pb-2">
                    <div class="col-12 text-center">
                        <ul class="footer-link">
                            <li>
                                <small>{{ __('ui.sva_prava') }}</small>
                            </li>
                            <li>
                                <a href="{{route("uslovi")}}">{{ __('ui.uslovi') }}</a>
                            </li>
                            <li>
                                <a href="{{route("kolacici")}}">{{ __('ui.kolacici') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
