                ...
                <li class="splide__slide">
                    <div class="slide-content">
                        <img class="stil-za-sliku" width="2200" height="800"
                            ...
                            alt="{{ __('home.slider_1_alt') }}" fetchpriority="high">
                        <div class="text-overlay left">
                            ...
                            <div class="moje-dugme-index-strana-slider">
                                <div class="bt_bb_service_content d-flex mojee">
                                    <img src="{{ asset('assets/img/icon/phone icon.png') }}"
                                        alt="{{ __('home.telefon_alt') }}">
                                    <div class="container-content">
                                        <div class="bt_bb_service_content_supertitle"><a
                                                href="tel:+381658234501">{{ __('home.pozovite') }}</a></div>
                                        <div class="bt_bb_service_content_title"><a href="tel:+381658234501">+381 65 823
                                                4501</a></div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-7">
                <div class="block-tekst">
                    ...
                    <a href="{{ route('nekretnineSve') }}"
                        class="moje-dugme-index-strana-slider d-inline-block px-4 py-3 mt-4">
            ...
            @foreach ($tipoviNekretnina as $a)
                <div class="block">
                    ...
                    <h2 class="text-block-tip-nekretnine text-uppercase">
                        ...
                        @endphp
                        <a
                            href="{{ route('nekretnineSvePoTipu', ['tip' => strpos($tipSaDonjomCrtom, 'ku') === 0 ? str_replace('c', 'ć', strtolower($tipSaDonjomCrtom)) : strtolower($tipSaDonjomCrtom)]) }}">
                            {{ $a->prevod()->tip }}
                        </a>
                    </h2>
                    @php
                        $slika = $a->slika;
                        [$width, $height] = getimagesize(public_path('assets/img/' . $slika->putanja));
                    @endphp
                    <img class="full-width-image" src="{{ asset('assets/img/' . $slika->putanja) }}"
                        alt="{{ $slika->alt }}" width="{{ $width }}" height="{{ $height }}" />
                </div>
            @endforeach
            <div class="block">
                <div class="box-shadow-efekat-tip-nekretnine"></div>
                ...
                <img width="705" height="705" class="full-width-image"
                    src="{{ asset('assets/img/wallpapers/beograd-nekretnine-banner.jpg') }}" alt="Beograd nekretnine" />
            </div>
        </div>
    </section>
