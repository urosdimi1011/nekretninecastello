            ...
            <div class="row mb-4" style="row-gap: 24px;">
                            ...
                            <form id="forma-kontakt">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="imeIPrezime" placeholder="{{ __('kontakt.ime_ph') }}">
                                        <small></small>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" placeholder="{{ __('kontakt.email_ph') }}">
                                    <p></p>
                                </div>
                                ...
                                @if (config('services.recaptcha.key'))
                                    <div class="g-recaptcha mb-3" data-sitekey="{{ config('services.recaptcha.key') }}">
                                    </div>
                                @endif
                ...
                <div class="col-12 col-md-5">
                    <div class="kontakt-slika-block" style="height:100%;min-height:300px">
                        <img src="{{ asset('assets/img/wallpapers/Castello-nekretnine-vrsac.jpeg') }}"
                            alt="Castello Nekretnine Vršac kancelarija" width="526" height="636" />
                    </div>
                </div>
            </div>
